const CACHE='runwise-static-v30';
const STATIC=['./','./index.html','./styles.css?v=28','./responsive.css?v=20','./app.js?v=30','./weather.js?v=19','./air-quality.js?v=19','./running-score.js?v=20','./running-coach.js?v=29','./pace-calculator.js?v=30','./charts.js?v=12','./storage.js?v=19','./solar-times.js?v=21','./utils.js','./running-score-config.js?v=14','./manifest.json','./icon.svg','./icon-192.png','./icon-512.png'];
